...
extern "C" NTSTATUS NTAPI PsSuspendProcess(
    _In_ PEPROCESS Process
);

extern "C" NTSTATUS NTAPI PsResumeProcess(
    _In_ PEPROCESS Process
);
...
// Memory Copy with Virtual Address
...
// Create UserMode Process THread API
extern "C" NTSTATUS
NTAPI
RtlCreateUserThread(
...
extern "C" BOOLEAN PsIsSystemProcess(
    PEPROCESS Process
);
